...
import 'package:flutter_parent/models/page.dart' as CanvasModel;
...
class _CourseFrontPageScreenState extends State<CourseFrontPageScreen> with AutomaticKeepAliveClientMixin {
  Future<CanvasModel.Page> _pageFuture;

  @override
  bool get wantKeepAlive => true;

  Future<CanvasModel.Page> _refreshPage() {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: FutureBuilder(
        future: _pageFuture,
        builder: (context, AsyncSnapshot<CanvasModel.Page> snapshot) {
